...
.method constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsEcmTimerCanceled:Z

    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCallInEcm:Z

    iput v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsDoubleCheckGetCurCall:I

    const/16 v0, 0x1388

    iput v0, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeout:I

    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeoutExpired:Z

    iput v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeoutCount:I
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mAssistDialPhoneNumberUtils:Lcom/lge/telephony/LGAssistDialPhoneNumberUtils;
...
.method declared-synchronized dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/gsm/GSMPhone;->exitEmergencyCallbackMode()V
    ...
    invoke-virtual {v5, p0, v6, v7}, Lcom/android/internal/telephony/gsm/GSMPhone;->setOnEcbModeExitResponse(Landroid/os/Handler;ILjava/lang/Object;)V

    iput p2, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCallClirMode:I

    iput-object p3, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCallUusInfo:Lcom/android/internal/telephony/UUSInfo;

    const/4 v5, 0x1

    iput-boolean v5, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCallInEcm:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget v6, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingOperations:I
    ...
    iget v6, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeoutCount:I
    ...
    const-string v7, ", mForegroundCall.getState()"
    ...
    const-string v7, ", mPendingOperations"
    ...
    const-string v7, ", mPollTimeoutCount="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeoutCount:I
    ...
    iput v10, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsDoubleCheckGetCurCall:I
    ...
    :pswitch_9
    iget-boolean v6, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCallInEcm:Z
    ...
    iget v8, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCallClirMode:I

    iget-object v9, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCallUusInfo:Lcom/android/internal/telephony/UUSInfo;

    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->obtainCompleteMessage()Landroid/os/Message;

    move-result-object v10

    invoke-interface {v6, v7, v8, v9, v10}, Lcom/android/internal/telephony/CommandsInterface;->dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Landroid/os/Message;)V

    iput-boolean v11, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCallInEcm:Z

    :cond_a
    iget-object v6, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPhone:Lcom/android/internal/telephony/gsm/GSMPhone;

    invoke-virtual {v6, p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->unsetOnEcbModeExitResponse(Landroid/os/Handler;)V
    ...
    const-string v7, "EVENT_POLL_DIAL_HANGUP_DONE: mPollTimeoutCount="
    ...
    const-string v7, ", fgCall.getState()="
    ...
    iput v6, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeoutCount:I
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->obtainMessage(I)Landroid/os/Message;

    move-result-object v6

    iget v7, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeout:I

    int-to-long v7, v7

    invoke-virtual {p0, v6, v7, v8}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    iput v11, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingOperations:I
...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCallInEcm:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCallInEcm:Z
