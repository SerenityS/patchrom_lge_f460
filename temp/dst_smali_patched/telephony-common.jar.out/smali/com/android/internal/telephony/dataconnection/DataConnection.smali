...
.method static synthetic access$6600(Lcom/android/internal/telephony/dataconnection/DataConnection;I)V
    ...
    .prologue
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/dataconnection/DataConnection;->removeMessages(I)V
...
.method private onSetupConnectionCompleted(Landroid/os/AsyncResult;)Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;
    ...
    .local v2, "response":Lcom/android/internal/telephony/dataconnection/DataCallResponse;
    ...
    const-string v5, "onSetupConnectionCompleted stale cp.tag="
    ...
    sget-object v3, Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;->ERR_Stale:Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;
    ...
    const-string v5, "onSetupConnectionCompleted failed, ar.exception="
    ...
    sget-object v3, Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;->ERR_BadCommand:Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;

    .restart local v3    # "result":Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;
    ...
    iput-object v4, v3, Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;->mFailCause:Lcom/android/internal/telephony/dataconnection/DcFailCause;
    ...
    iget v4, v2, Lcom/android/internal/telephony/dataconnection/DataCallResponse;->version:I
    ...
    :cond_2
    sget-object v3, Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;->ERR_GetLastErrorFromRil:Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;
    ...
    .end local v3    # "result":Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;
    :cond_3
    sget-object v3, Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;->ERR_RilError:Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;

    .restart local v3    # "result":Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;
    iget v4, v2, Lcom/android/internal/telephony/dataconnection/DataCallResponse;->status:I
    ...
    const-string v5, "onSetupConnectionCompleted received DataCallResponse: "
    ...
    iget-boolean v4, v4, Lcom/android/internal/telephony/lgdata/LgDataFeature;->LGP_DATA_DISPLAY_IP_MPDN_KR:Z

    if-eqz v4, :cond_b

    if-eqz v2, :cond_a

    iget-object v4, v2, Lcom/android/internal/telephony/dataconnection/DataCallResponse;->addresses:[Ljava/lang/String;
    ...
    const-string v4, "[LGE_DATA] Addresses is invalid. initialization Address."

    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/dataconnection/DataConnection;->log(Ljava/lang/String;)V

    new-array v4, v7, [Ljava/lang/String;

    iput-object v4, v2, Lcom/android/internal/telephony/dataconnection/DataCallResponse;->addresses:[Ljava/lang/String;
    ...
    iget-object v5, v2, Lcom/android/internal/telephony/dataconnection/DataCallResponse;->addresses:[Ljava/lang/String;
    ...
    const-string v5, "[LGE_DATA] response.addresses["
    ...
    invoke-virtual {v4, v9, v5, v8}, Lcom/android/internal/telephony/PhoneBase;->setModemStringItem(ILjava/lang/String;Landroid/os/Message;)V
    ...
    const-string v4, "[chisung] SKT ipv6 address display"
    ...
    iget-object v6, v2, Lcom/android/internal/telephony/dataconnection/DataCallResponse;->addresses:[Ljava/lang/String;

    aget-object v6, v6, v1

    invoke-virtual {v4, v5, v6, v8}, Lcom/android/internal/telephony/PhoneBase;->setModemStringItem(ILjava/lang/String;Landroid/os/Message;)V

    goto/16 :goto_2

    .end local v1    # "i":I
    :cond_a
    const-string v4, "response or response.addresses is null"
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/dataconnection/DataConnection;->updateLinkProperty(Lcom/android/internal/telephony/dataconnection/DataCallResponse;)Lcom/android/internal/telephony/dataconnection/DataConnection$UpdateLinkPropertyResult;

    move-result-object v4

    iget-object v3, v4, Lcom/android/internal/telephony/dataconnection/DataConnection$UpdateLinkPropertyResult;->setupResult:Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;
    ...
    .restart local v3    # "result":Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;
    const-string v4, "[LGE_DATA] response is null, result[ERR_GetLastErrorFromRil]"
