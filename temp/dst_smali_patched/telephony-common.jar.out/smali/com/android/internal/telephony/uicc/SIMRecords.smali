...
.method private getSpnFsm(ZLandroid/os/AsyncResult;)V
    ...
    iget v5, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mSubId:I
    ...
    :pswitch_0
    iput-object v10, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mSpn:Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mSpn:Ljava/lang/String;
...
.method private insertSmsDB(ILandroid/telephony/SmsMessage;)Landroid/net/Uri;
    ...
    :try_start_0
    sget-object v8, Lcom/android/internal/telephony/uicc/SIMRecords;->SMS_SENT_URI:Landroid/net/Uri;
    ...
    const-string v13, "sim_mo_unknown_time"
    ...
    const-string v13, "parse_email_on_uicc"
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/internal/telephony/uicc/SIMRecords;->extractEmailAddressFromMessageBody(Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;
    ...
    const-string v13, "sms_separate_usimbox"
    ...
    const-string v13, "kr_address_spec"
    ...
    const-string v13, "reply_address"
    ...
    .local v10, "uiAddress":Ljava/lang/String;
    :goto_3
    ...
    .end local v10    # "uiAddress":Ljava/lang/String;
    const-string v12, "Unknown"

    invoke-direct {v10, v12}, Ljava/lang/String;-><init>(Ljava/lang/String;)V

    .restart local v10    # "uiAddress":Ljava/lang/String;
    :cond_7
    ...
    .end local v10    # "uiAddress":Ljava/lang/String;
    :goto_4
    const-string v13, "original_address"
    ...
    :cond_8
    const-string v13, "reply_path_present"
    ...
    const-string v12, "insertSmsDB(), SMS_FORMAT : SMS_FORMAT_USIM: 1"
    ...
    :cond_9
    :try_start_1
    iget-object v12, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mContext:Landroid/content/Context;

    invoke-virtual {v12}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v12

    invoke-virtual {v12, v8, v11}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;

    move-result-object v9

    if-nez v9, :cond_a

    const-string v12, "insertSmsDB(), smsInsertUri is null"
    ...
    :try_start_2
    sget-object v8, Lcom/android/internal/telephony/uicc/SIMRecords;->SMS_INBOX_URI:Landroid/net/Uri;
    ...
    sget-object v8, Lcom/android/internal/telephony/uicc/SIMRecords;->SMS_OUTBOX_URI:Landroid/net/Uri;
    ...
    const-string v13, "dcm_support_sim_load_voice_mail_tp_oa_address_ntt_docomo"
    ...
    const-string v12, "insertSmsDB(), SQL Insert error"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .local v27, "vsim_imsi":Ljava/lang/String;
    const/16 v28, 0x0

    .local v28, "vsim_mcc_mnc":Ljava/lang/String;
    ...
    .end local v27    # "vsim_imsi":Ljava/lang/String;
    .end local v28    # "vsim_mcc_mnc":Ljava/lang/String;
    :cond_5
    :goto_3
    move-object/from16 v0, p0
    ...
    iget v4, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->mSubId:I
    ...
    .restart local v27    # "vsim_imsi":Ljava/lang/String;
    .restart local v28    # "vsim_mcc_mnc":Ljava/lang/String;
    :cond_e
    ...
    .local v26, "vsim_gid1":Ljava/lang/String;
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    iput-object v0, v1, Lcom/android/internal/telephony/uicc/SIMRecords;->mGid1:Ljava/lang/String;

    .end local v26    # "vsim_gid1":Ljava/lang/String;
    :cond_45
    :goto_19
    ...
    .end local v23    # "recordSizeArray":[I
    :cond_48
...
.method public initUSimSmsUpdate()V
    .locals 1

    .prologue
    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/internal/telephony/uicc/SIMRecords;->isUSimSmsUpdateStarted:Z
...
.method protected onRecordLoaded()V
    ...
    iget v5, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mMncLength:I
...
.method protected resetRecords()V
    ...
    iget v1, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mSubId:I
