...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v3}, Lcom/android/internal/telephony/uicc/UiccController;->log(Ljava/lang/String;)V

    iget-object v3, p0, Lcom/android/internal/telephony/uicc/UiccController;->mCi:Lcom/android/internal/telephony/CommandsInterface;

    const/4 v5, 0x2

    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/uicc/UiccController;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-static {v3}, Lcom/lge/uicc/LGUICC;->targetCountry([Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_1

    iget-boolean v3, p0, Lcom/android/internal/telephony/uicc/UiccController;->isBoot:Z

    if-eqz v3, :cond_1

    iget-object v3, p0, Lcom/android/internal/telephony/uicc/UiccController;->mUiccCard:Lcom/android/internal/telephony/uicc/UiccCard;
    ...
    const-string v5, "[ISIM] Send Intent - IPUtils.INTENT_GBA_INIT"

    invoke-static {v3, v5}, Landroid/telephony/Rlog;->e(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v1, Landroid/content/Intent;

    const-string v3, "com.movial.gba_initialized"
    ...
    iput-boolean v3, p0, Lcom/android/internal/telephony/uicc/UiccController;->isBoot:Z
    ...
    invoke-virtual {v3, v5}, Lcom/android/internal/telephony/uicc/UiccCard;->getApplication(I)Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/uicc/UiccController;->isAirplaneModeOn(Landroid/content/Context;)Z
    ...
    const-string v5, "Airplane mode is on. Forcing update sim status"
    ...
    invoke-direct {p0, v3}, Lcom/android/internal/telephony/uicc/UiccController;->handleRefresh(Lcom/android/internal/telephony/uicc/IccRefreshResponse;)V
