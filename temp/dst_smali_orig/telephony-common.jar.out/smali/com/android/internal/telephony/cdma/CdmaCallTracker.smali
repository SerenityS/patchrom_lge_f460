...
.method public constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    invoke-virtual {v1, v5}, Lcom/android/internal/telephony/cdma/CdmaCall;->setGeneric(Z)V
...
.method static synthetic access$000(Lcom/android/internal/telephony/cdma/CdmaCallTracker;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/cdma/CdmaCallTracker;
...
.method private disableDataCallInEmergencyCall(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v7}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->setInternalDataEnabled(Z)Z
    ...
    const-string v4, "E911 WiFi : Wifi is disabling ..."

    invoke-static {v3, v4}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {v2, v6}, Landroid/net/wifi/WifiManager;->setWifiNeedOn(Z)Z
...
.method public dispose()V
    ...
    invoke-interface {v8, p0}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForLineControlInfo(Landroid/os/Handler;)V

    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mCi:Lcom/android/internal/telephony/CommandsInterface;

    invoke-interface {v8, p0}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForCallStateChanged(Landroid/os/Handler;)V
    ...
    invoke-interface {v8, p0}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForNotAvailable(Landroid/os/Handler;)V

    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mCi:Lcom/android/internal/telephony/CommandsInterface;

    invoke-interface {v8, p0}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForCallWaitingInfo(Landroid/os/Handler;)V
    ...
    invoke-interface {v8, p0}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForT53ReleaseInfoKddi(Landroid/os/Handler;)V
    ...
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-interface {v8, p0}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForSignalInfo(Landroid/os/Handler;)V
    ...
    const-string v9, "dispose: call connnection onDisconnect, cause LOST_SIGNAL"
    ...
    invoke-virtual {v1, v8}, Lcom/android/internal/telephony/cdma/CdmaConnection;->onDisconnect(Lcom/android/internal/telephony/Connection$DisconnectCause;)Z
    :try_end_0
    .catch Lcom/android/internal/telephony/CallStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v9, "dispose: unexpected error on hangup"
    ...
    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->hangup(Lcom/android/internal/telephony/cdma/CdmaConnection;)V

    const-string v8, "CdmaCallTracker"

    const-string v9, "dispose: call mPendingMO.onDsiconnect, cause LOST_SIGNAL"
    ...
    invoke-virtual {v8, v9}, Lcom/android/internal/telephony/cdma/CdmaConnection;->onDisconnect(Lcom/android/internal/telephony/Connection$DisconnectCause;)Z
    :try_end_1
    ...
    const-string v9, " disconnect call because mDroppedDuringPoll is not null during dispose CCT"
    ...
    invoke-virtual {v2, v8}, Lcom/android/internal/telephony/cdma/CdmaConnection;->onRemoteDisconnect(I)V
    ...
    const-string v9, "mDroppedDuringPoll.clear()"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-boolean v15, v15, Lcom/android/internal/telephony/cdma/CDMAPhone;->mIsTheCurrentActivePhone:Z
    ...
    iget-object v15, v0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLastRelevantPoll:Landroid/os/Message;
    ...
    iput-boolean v15, v0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mNeedsPoll:Z

    const/4 v15, 0x0

    move-object/from16 v0, p0

    iput-object v15, v0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLastRelevantPoll:Landroid/os/Message;
    ...
    iget-object v15, v0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mCi:Lcom/android/internal/telephony/CommandsInterface;
    ...
    invoke-virtual {v0, v12}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->sendMessage(Landroid/os/Message;)Z
