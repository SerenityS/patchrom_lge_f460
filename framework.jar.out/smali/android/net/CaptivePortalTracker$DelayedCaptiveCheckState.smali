...
.method public enter()V
    ...
    # getter for: Landroid/net/CaptivePortalTracker;->DELAYED_CHECK_INTERVAL_MS:I
    invoke-static {}, Landroid/net/CaptivePortalTracker;->access$4300()I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v6, v7}, Landroid/net/CaptivePortalTracker;->access$4400(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    invoke-static {v6}, Landroid/net/CaptivePortalTracker;->access$3000(Landroid/net/CaptivePortalTracker;)V
    ...
    invoke-static {v7}, Landroid/net/CaptivePortalTracker;->access$4500(Landroid/net/CaptivePortalTracker;)Ljava/lang/String;
    ...
    invoke-static {v3}, Landroid/net/CaptivePortalTracker;->access$1902(Ljava/net/InetAddress;)Ljava/net/InetAddress;
    ...
    invoke-static {v6, v3}, Landroid/net/CaptivePortalTracker;->access$4700(Landroid/net/CaptivePortalTracker;Ljava/net/InetAddress;)Z
    ...
    const-string v5, "android.net.conn.CAPTIVE_NETWORK_DETECTED"
    ...
    # invokes: Landroid/net/CaptivePortalTracker;->log(Ljava/lang/String;)V
    invoke-static {v5, v6}, Landroid/net/CaptivePortalTracker;->access$4800(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6, v0}, Landroid/net/CaptivePortalTracker;->access$5000(Landroid/net/CaptivePortalTracker;Landroid/net/NetworkInfo;Z)V
    ...
    invoke-static {v5}, Landroid/net/CaptivePortalTracker;->access$1500(Landroid/net/CaptivePortalTracker;)Landroid/net/IConnectivityManager;
    ...
    invoke-static {v9}, Landroid/net/CaptivePortalTracker;->access$5100(Landroid/net/CaptivePortalTracker;)Ljava/lang/String;
    ...
    invoke-static {v6}, Landroid/net/CaptivePortalTracker;->access$5200(Landroid/net/CaptivePortalTracker;)Lcom/android/internal/util/State;

    move-result-object v6

    # invokes: Landroid/net/CaptivePortalTracker;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v6}, Landroid/net/CaptivePortalTracker;->access$5300(Landroid/net/CaptivePortalTracker;Lcom/android/internal/util/IState;)V
